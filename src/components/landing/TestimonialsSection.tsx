...
const AvatarCircle = ({ name, color }: { name: string; color: string }) => {
  ...
  return (
    <div
      className="w-16 h-16 rounded-full flex items-center justify-center text-xl font-bold text-gray-800 font-playful"
...
const TestimonialCard = ({ testimonial, delay }: { testimonial: Testimonial; delay: number }) => {
  ...
  return (
    <motion.div
      className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10">
        {/* Testimonial Text */}
        <p className="text-gray-700 mb-6 leading-relaxed font-playful text-base md:text-lg">
          "{testimonial.text}"
        </p>
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h4 className="font-bold text-gray-900 font-playful text-lg">
              {testimonial.name}
            </h4>
            <p className="text-gray-600 font-playful text-sm">
              {testimonial.role}
            </p>
          </div>
        </div>
        ...
        <motion.button
          ...
          className="font-semibold text-sm font-playful flex items-center gap-1 group"
          style={{ color: "#2BD4D0" }}
...
export const TestimonialsSection = () => {
  return (
    <section className="relative pt-0 pb-20 lg:pb-28 bg-[#FEF6E4] overflow-hidden -mt-16">
      {/* Decorative background elements */}
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          className="absolute w-64 h-64 rounded-full bg-purple-200 opacity-10"
          style={{ top: "10%", left: "-5%" }}
          animate={{
            scale: [1, 1.1, 1],
        ...
        />
        <motion.div
          className="absolute w-48 h-48 rounded-full bg-pink-200 opacity-10"
      ...
      <div className="container mx-auto px-[30px] relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6 font-playful">

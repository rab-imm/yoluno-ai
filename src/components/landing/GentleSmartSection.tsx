...
export const GentleSmartSection = () => {
  const bulletPoints = [
    { text: "Yoluno doesn't just respond.", bgColor: "#E0F2FE" },
    { text: "It listens.", bgColor: "#FCE7F3" },
    { text: "It encourages.", bgColor: "#FEF3C7" },
    { text: "And it grows with your child.", bgColor: "#E9D5FF" }
  ];

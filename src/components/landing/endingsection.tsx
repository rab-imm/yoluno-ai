      ...
      <div className="container mx-auto px-[30px] relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="w-full max-w-md mx-auto lg:max-w-sm" style={{ aspectRatio: "1 / 1", minHeight: "300px" }}>
                <DotLottieReact
                  src={lottiePath}
                  loop
                  autoplay
            ...
            >
              {/* Heading */}
              <div>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-gray-900 mb-3 font-playful leading-tight">
                  Where Little Hearts Grow with Love
                </h2>
                <p className="text-base md:text-lg text-gray-700 font-playful leading-relaxed mb-4">
              ...
              >
                <motion.button
                  ...
                  className="group text-white font-bold py-3 px-6 rounded-xl flex items-center justify-center gap-2 font-playful text-base transition-all duration-300 shadow-md hover:shadow-lg"
                  style={{
